...
module.exports = function (input) {
  ...
  var start = function start(line) {
    var _parseFiles;
    var _ref =
        (_parseFiles = parseFiles(line)) !== null && _parseFiles !== void 0
          ? _parseFiles
          : [],
  ...
  var eof = function eof(line) {
    ...
    currentChunk.changes.push(
      ...
      _defineProperty(_currentChunk$changes3, mostRecentChange.type, true),
      _defineProperty(_currentChunk$changes3, "ln1", mostRecentChange.ln1),
      _defineProperty(_currentChunk$changes3, "ln2", mostRecentChange.ln2),
...
var parseFiles = function parseFiles(line) {
  var fileNames =
    line === null || line === void 0 ? void 0 : line.match(fileNameDiffRegex);
...
var formTrimmingString = function formTrimmingString(trimmingChars) {
  ...
  return "[".concat(
    makeString(trimmingChars).replace(/([.*+?^=!:${}()|[\]/\\])/g, "\\$1"),
    "]"
  );
};
var makeString = function makeString(itemToConvert) {
  return (
    (itemToConvert !== null && itemToConvert !== void 0 ? itemToConvert : "") +
    ""
  );
};
